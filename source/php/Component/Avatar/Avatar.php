...
class Avatar extends \ComponentLibrary\Component\BaseController
{
    ...
    public function classList()
    {
        $this->data['classList'][] = $this->compParams['size']
            ? $this->getBaseClass() . '--size-' . $this->compParams['size']
            : null;
    ...
    public function setIconParams()
    {
        ...
        $defaultSize = !empty($this->compParams['icon']['size'])
            ? $this->compParams['icon']['size']
            : $this->compParams['size'];

        $this->data['icon']['name'] = !empty($this->compParams['icon']['name'])
            ? $this->compParams['icon']['name']
            : null;
    ...
    {
        if (
            !empty($this->compParams['name'])
            && empty($this->compParams['image'])
            && empty($this->compParams['icon']['name'])
        ) {
