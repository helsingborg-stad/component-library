...
class Fileinput extends \ComponentLibrary\Component\BaseController implements FileinputInterface
{
    private $filesMax = 50;
    ...
    // -------------------------------------------------------------------------
    // FileinputInterface — generated getters
    // -------------------------------------------------------------------------
    ...
    {
        return $this->data['preview'] ?? false;
    }
